...
public class CenterMeFragment extends BaseFragment<CenterMePresenter> {
    ...
    private static final String TAG = CenterMeFragment.class.getSimpleName();

//    private CountDownTimer mTimer;

    private CenterMePresenter mShopCarPresenter;
    private HangXunWebView mWebContainer;

    @Override
    protected CenterMePresenter onCreateTopPresenter() {
        mShopCarPresenter = new CenterMePresenter(getActivity());
...
//        }
    ...
    private void showWeb() {
        String url = CenterApiConstants.BASE_URL + CenterApiConstants.HOME_ME
