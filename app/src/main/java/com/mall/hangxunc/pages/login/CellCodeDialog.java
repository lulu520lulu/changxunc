...
public class CellCodeDialog extends Dialog {
    ...
    private void init(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.mall_cell_code_dialog_layout, null, false);
        setContentView(view);
    ...
    class CellCodeAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.mall_list_cell_code_item, parent, false);
