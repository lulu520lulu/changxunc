...
import com.mall.hangxunc.bean.home.CountryBean;
import com.mall.hangxunc.bean.login.LoginData;
import com.mall.hangxunc.bean.login.LoginInfo;
...
public class LoginFragment extends BaseFragment<LoginPresenter> {
    ...
    protected View onCreateViewImpl(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.mall_fragment_login, null);
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.show_email:
                        ...
                        showEmail.setBackgroundResource(R.drawable.mall_login_radio_checked_bg);
                    ...
                    case R.id.show_phone:
                        ...
                        showPhone.setBackgroundResource(R.drawable.mall_login_radio_checked_bg);
