...
public class MallSpecialAdapter extends RecyclerView.Adapter {
    private Context mContext;
    private List<ProductBean> mData;

    public MallSpecialAdapter(Activity mContext, List<ProductBean> list) {
        this.mData = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.mall_list_product_xian_item, parent, false);
