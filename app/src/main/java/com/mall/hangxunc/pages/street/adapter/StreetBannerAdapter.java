...
class StreetBannerAdapter extends RecyclerView.Adapter {
    private Context mContext;
    private List<BannersBean> mData;

    public StreetBannerAdapter(Context mContext, List<BannersBean> products) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.street_list_banner_item, parent, false);
        ...
        if (viewHolder.itemView != null) {
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    JumpUtils.goWeb(StreetApiConstants.BASE_URL + bean.getLink());
                }
            });
        }
    }
