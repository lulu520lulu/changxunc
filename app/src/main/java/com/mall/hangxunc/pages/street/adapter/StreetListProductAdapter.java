...
class StreetListProductAdapter extends RecyclerView.Adapter {
    private Context mContext;
    private List<ProductBean> mData;

    public StreetListProductAdapter(Context mContext, List<ProductBean> products) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.street_list_product_item, parent,false);
