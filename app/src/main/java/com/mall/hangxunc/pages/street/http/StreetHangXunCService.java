...
//    Call<ProductListBean> getHomeBottom(@Query("sco") String custom_id, @Query("language") String language, @Query("currency") String currency);
     ...
     * @return
     */
    @GET(StreetApiConstants.GET_ALL_PRODUCT_MOBILE_PATH)
    Call<StreetAllProductBean> getAllProduct(@Query("sco") String custom_id, @Query("count") int count,
...
//    Call<LanguageBean> getCopyRight();
    ...
    Call<StreetIsLoginBean> isCustomerLogin(@Query("sco") String sco,@Query("app") String app);
