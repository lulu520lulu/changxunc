...
public class StreetAllPostRecycleAdapter extends RecyclerView.Adapter {

    private Context mContext;
    private ArrayList<PostsBean> mData;

    public StreetAllPostRecycleAdapter(Context context, ArrayList<PostsBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.street_all_post_list_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        Glide.with(mContext)
                .load(StreetApiConstants.IMAGE_BASE_URL + "/" + postsBean.getImage())
                .apply(options)
