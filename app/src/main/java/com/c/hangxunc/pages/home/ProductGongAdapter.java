...
class ProductGongAdapter extends RecyclerView.Adapter {
    private Context mContext;
    private List<ProductBean> mData;

    public ProductGongAdapter(Activity mContext, List<ProductBean> list) {
        this.mData = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.list_product_gong_item, parent, false);
        ProductGongAdapter.MyViewHolder holder = new ProductGongAdapter.MyViewHolder(view);
        return holder;
    }
